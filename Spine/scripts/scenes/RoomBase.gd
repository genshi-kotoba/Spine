...
func _build_room() -> void:
	...
	_collider_box("WallLeft", Vector2(0, ceiling_y), Vector2(THICKNESS, wall_height + THICKNESS), wall_color)
	_collider_box("WallRight", Vector2(room_width, ceiling_y), Vector2(THICKNESS, wall_height + THICKNESS), wall_color)
